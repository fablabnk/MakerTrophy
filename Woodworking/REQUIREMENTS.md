...
The completed base should...
- be made from an offcut wooden piece you find in the lab
- include drill holes (or other connectors) which the 3D printed base can slot into securely
- be constructed using only basic woodworking tools i.e.
    - hand saw for basic shaping
    - sandpaper or orbital sander for smoothing
    - standing drill for making the holes
